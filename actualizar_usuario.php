...
<?php
	...
	$sql="UPDATE usuarios SET usuario='$usuario', password = SHA1('$password'), nombre='$nombre', idusuario='$idusuario', apellidos='$apellidos', rolusertecno='$rolusuatecnoaca' WHERE id='$id'";
