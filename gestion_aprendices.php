...
<div style="margin:10px" class="row table-responsive">
 ...
 <thead>
	...
	<th><strong>Periodicidad</strong></th>
...
<td><a href="modificar_aprendiz.php?id=<?php echo $row['id'];?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
	...
	<td><?php echo $row['periodoest'];?></td>
	<td><?php echo $row['lineauno'];?></td>
	<td><?php echo $row['subareauno'];?></td>  
	<td><?php echo $row['facilitadoruno'];?></td>	
    <td><?php echo $row['estadouno'];?></td>	
   </tr> 
 <?php } ?>
  </tbody>
</table>
