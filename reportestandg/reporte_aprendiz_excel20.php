...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="41" bgcolor="#25BABA"><CENTER>
      <strong>Aprendices Tecnoacademia 2020</strong>
    </CENTER></td>
  </tr>
  <tr>
...
$query=mysqli_query($mysqli, "SELECT aprendiz.tipodoc, aprendiz.numident, aprendiz.depexp, aprendiz.munexp, aprendiz.fexp, aprendiz.fvenc, aprendiz.nombre, aprendiz.apellidos, aprendiz.fnac, aprendiz.depnac, aprendiz.munnac, aprendiz.genero, aprendiz.estrato, aprendiz.grupoEtnico, aprendiz.discapacidad, aprendiz.poblacionVulnerable, aprendiz.epsestud, aprendiz.gsyrh, aprendiz.email, aprendiz.telfijo, aprendiz.telcelular, aprendiz.dir, aprendiz.nomacud, aprendiz.telacud, aprendiz.insed, aprendiz.grado, aprendiz.fingre, aprendiz.periodoest, aprendiz.lineauno, aprendiz.subareauno, aprendiz.facilitadoruno, aprendiz.tipformlinestuno, aprendiz.estadouno, aprendiz.fechestadouno, aprendiz.lineados, aprendiz.subareados, aprendiz.facilitadordos, aprendiz.tipformlinestdos, aprendiz.estadodos, aprendiz.fechestadodos, tecnoacademia.nombretecno FROM aprendiz INNER JOIN tecnoacademia ON aprendiz.tecnoacademia=tecnoacademia.idtecnoacademia");
