...
<p>&nbsp; </p>				
			<?php if($resultado>0){ ?>
				<h1 class="subtitulo">¡ Inst.Eeducativa Eliminada !</h1>
				<?php }else{ ?>
				<h1 class="subtitulo">¡ Error al eliminar I.E.</h1>		
			<?php	} ?>		
			
			<p></p>	<br />
			
           <a class="btn btn-default btn-lg" href="gestion_ie.php">Eliminar otra I.E</a>
