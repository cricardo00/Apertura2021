...
<?php
	...
	$rolusuatecnoaca=$_POST['rolusuatecnoaca'];
	$rolusuatecnoaca = strtoupper($rolusuatecnoaca);
...
<p>&nbsp; </p>
	...
	<?php } else{ ?>
		<?php $query="INSERT INTO usuarios (usuario, password, id_tipo, idusuario, nombre, apellidos, rolusertecno, tipotecno) VALUES ('$usuario',SHA1('$contrasena'),'$roltecno', '$idusuario', '$nombres','$apellidos','$rolusuatecnoaca','$tecnoacademia')";
