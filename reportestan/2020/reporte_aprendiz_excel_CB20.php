...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="40" bgcolor="#25BABA"><CENTER>
      <strong>Aprendices Tecnoacademia 2020</strong> - Ciencias Básicas
    </CENTER></td>
  </tr>
  <tr>
...
$query=mysqli_query($mysqli, "SELECT * FROM aprendiz WHERE tecnoacademia = $idtecnorep AND linea = 'CIENCIAS BASICAS'");
