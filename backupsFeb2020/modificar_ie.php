...
<table>
	...
	<table id="tab">
	  ...
	  <tr>
		...
		<td>
        	...
        	<option value="Publica" <?php if($rowie['tipo_ie']=='Publica') echo 'selected'; ?>>Pública</option>
			<option value="Privada" <?php if($rowie['tipo_ie']=='Privada') echo 'selected'; ?>>Privada</option>
			</select>
		</td>	
	</tr>
	  ...
	  <tr>
	    ...
	    <td><select class="cajas" name="municipio_ie" id="municipio_ie" required placeholder="municipio de Expedición">
	      <option value="<?php echo $row['municipio_ie']; ?>" selected><?php echo $row['municipio_ie']; ?></option>
        </select></td>
      </tr>
	...
	<td><select class="cajas" name="zona_ie" id="zona_ie" required placeholder="zona_ie">
	  <option value="0"> Seleccione </option>
	  <option value="Rural"<?php if($rowie['zona_ie']=='Rural') echo 'selected'; ?>>Rural</option>
	  <option value="Urbana"<?php if($rowie['zona_ie']=='Urbana') echo 'selected'; ?>>Urbana</option>
	  </select></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>	
	<td>&nbsp;</td>
