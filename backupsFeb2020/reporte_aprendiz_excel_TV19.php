...
$query=mysqli_query($mysqli, "SELECT tipodoc, numident, depexp, munexp, fexp, fvenc, nombre, apellidos, fnac, depnac, munnac, genero, estrato, grupoEtnico, discapacidad, poblacionVulnerable, email, telfijo, telcelular, dir, nomacud, telacud, fingre, linea, subarea, facilitador, insed, grado, estado FROM aprendiz WHERE tecnoacademia = $idtecnorep AND linea = 'TICS'");
