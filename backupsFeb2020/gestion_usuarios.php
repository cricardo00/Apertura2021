<?php
	...
	$sql= "SELECT id, usuario, nombre, apellidos, tipotecno FROM usuarios WHERE tipotecno=".$fila['tipotecno']; // Se realiza consulta para seleccionar y mostrar datos segun la tecnoacademia 
