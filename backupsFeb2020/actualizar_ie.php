...
<?php
	...
	$sql="UPDATE instituciones SET nombre_ie='$nombre_ie', municipio_ie='$municipio_ie', tipo_ie='$tipo_ie', zona_ie='$zona_ie', contacto_ie='$contacto_ie', telcontacto_ie='$telefono_ie', email_ie='$email_ie'  WHERE id='$id'";
