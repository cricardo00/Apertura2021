...
<?php
	...
	$sql="UPDATE aprendiz SET tipodoc='$tipodoc', numident='$numident', depexp='$depexp', munexp='$munexp', fexp='$fexp',fvenc='$fvenc', nombre='$nombre', apellidos='$apellidos', fnac='$fnac', depnac='$depnac', munnac='$munnac', genero='$genero', estrato='$estrato', grupoEtnico='$gruposetnicos', discapacidad='$discapacidad', 	poblacionVulnerable='$poblacionvulnerable', email='$email', telfijo='$telfijo', telcelular='$telcelular', dir='$dir', nomacud='$nomacud', telacud='$telacud', fingre='$fingre', linea='$linea', subarea='$subArea', facilitador='$facilitador', insed='$insed', grado='$grado', estado='$estado' WHERE id='$id'";
