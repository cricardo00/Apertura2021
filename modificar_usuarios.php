...
<table>
	...
	<td width="174"></td>
	<td><input type="hidden" name="roltecno" id="roltecno" value="2"></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	</tr>
	...
	<td>&nbsp;</td>
	<td>Rol Tecnoacademia:</td>
	<td><select name="rolusuatecnoaca" required id="rolusuatecnoaca" placeholder="Rol en la Plataforma">
	  <option value="<?php echo $row['rolusertecno']; ?>" selected><?php echo $row['rolusertecno']; ?></option>
